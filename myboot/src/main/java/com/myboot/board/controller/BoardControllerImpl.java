package com.myboot.board.controller;
...
import com.myboot.board.service.BoardService;
...
public class BoardControllerImpl implements BoardController{
	...
	private String upload(MultipartHttpServletRequest multipartRequest) throws
	Exception {
		...
		while(fileNames.hasNext()) {
			...
			if(mFile.getSize()!=0) { // File Null Check 체크체크츠ㅔ크체ㅡㅊ케츠ㅔ케케ㅔ켘케
